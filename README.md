...
The current development setup is verified on Windows with local MCP `stdio` revision `2025-11-25`. Packages remain private and unreleased. Other platforms, consumers and release capabilities are claimed only after their roadmap gates pass.
