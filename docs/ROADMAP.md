...
| 2 | `M3-S02` — Public Protocol SDK and conformance distribution | `Ready` | Locally installable artifacts expose the public Protocol SDK, schemas, fixtures and provider/consumer conformance suite with explicit exports/types and fail-closed supported/unsupported-version tests. | Integrated M3-S01; `FMU-FR-009`, `FMU-FR-010`, `FMU-FR-023`; `FMU-NFR-001`, `FMU-NFR-009`, `FMU-NFR-017`; M3 public SDK/protocol/conformance deliverable. |
