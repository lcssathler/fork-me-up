...
| 8 | `M2-S08` — Source-backed Demand Profile producer | `Ready` | Bounded current-project/task inputs produce a schema-valid Demand Profile and ask at most one high-information question only when ambiguity materially changes behavior or risk. | M2-S07; `FMU-FR-003`, `FMU-FR-021`; `FMU-E-009`, `FMU-E-010`; ADR-0010. |
