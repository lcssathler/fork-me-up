...
| 10 | `M2-S10` — Owner inspection and correction workflow | `Ready` | A no-LLM owner interface inspects, edits, corrects, disputes, and rejects Claims; correction precedence remains traceable and success is reported only after validated persistence. | M2-S09; `FMU-FR-013`, `FMU-FR-014`; `FMU-E-005`, `FMU-E-011`. |
