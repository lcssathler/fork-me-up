...
| 4 | `M1-S04` — Deterministic bounded DCP compiler | `Ready` | Core emits schema-valid DCPs with injected time/identifiers, deterministic disclosure reduction, strict byte/token budgets, canary redaction, and repository-instruction isolation. | M1 compiler and security deliverables; `FMU-FR-007`, `FMU-FR-009`, `FMU-FR-026`; `FMU-NFR-002`, `FMU-NFR-005`, `FMU-NFR-007`, `FMU-NFR-011`; `FMU-E-012`, `FMU-E-013`; ADR-0007. |
