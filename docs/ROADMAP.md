...
| 12 | `M2-S12` — Bounded evidence lookup and secret-safe doctor | `Ready` | The owner can request bounded capability evidence and diagnose installation, schema, adapter, cache, and context-size state without exposing source, secrets, personal paths, or canaries. | M2-S11; `FMU-FR-010`, `FMU-FR-022`, `FMU-FR-023`, `FMU-FR-026`; `FMU-E-015`. |
