...
After M0-S03 is integrated into `main`, the immediate next action is M0-S04, the toolchain/workspace decision and package foundation. No `FMU-E-*` evaluation applies to the licensing slice because it governs repository licensing and delivery rather than product behavior. Any behavioral spike before the M0 exit gate is disposable and cannot enter product code.
