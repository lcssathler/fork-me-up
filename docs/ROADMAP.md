...
| 3 | `M1-S03` — Demand/profile intersection | `Ready` | Pure task relevance intersects a validated Demand Profile with fixture profile state and omits irrelevant expertise without compiling or transporting a final packet. | M1 Demand Profile input; `FMU-FR-003`, `FMU-FR-007`, `FMU-FR-008`; `FMU-E-006`; ADR-0010. |
