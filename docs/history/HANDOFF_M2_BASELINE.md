# Historical handoff at M2 completion

> Preserved from main cc93ae9. Its full-corpus reading instruction is superseded by [AGENTS.md](../../AGENTS.md). Use the [current handoff](../HANDOFF.md).
